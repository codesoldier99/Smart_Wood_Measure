...
def inference_wood(depth_pic_path, input_dir):
    ...
    # 深度阈值 车尾约2500 车头约4000，单位mm
    Depth_threshold = 2500
    # Depth_threshold = 4000
    # 深度图像地址
    # depth_pic_path = r"D:\depth_PNG_37317637_1242_14-03-2023-15-40-07.png"
    # 原图地址
    # input_dir = r"D:\DepthViewer_Left_37317637_1242_14-03-2023-15-40-03.png"
    # 结果保存路径
    output_dir = "C:/backup2022_12_5/backup2022_12_5/Qt-Camera/result"
    # 自动在输入路径下生成最终结果的文件夹
    # output_dir = input_dir + '/' + 'cv_result_mix_min'

    # 模型配置文件地址

    config_dir = 'C:/backup2022_12_5/backup2022_12_5/tree_test/xuezhang/mask_rcnn_r2_101_fpn_1x_coco_wood.py'
    checkpoint_dir = 'C:/backup2022_12_5/backup2022_12_5/tree_test/xuezhang/epoch_36.pth'
    ...
    if segm_result is not None:  # non empty
        ...
        for i in inds:
            ...
            D = depth_XY_data * np.sqrt(
                (x1 - x2) * (x1 - x2) / (1049.29 * 1049.29) + (y1 - y2) * (y1 - y2) / (1049.29 * 1049.29)) / (10.0 * 1.03)
            print("深度值："+str(count1), depth_XY_data)
...
#     inference_wood("C:/backup2022_12_5/backup2022_12_5/Qt-Camera/pic/depth20230911163856.png",
#               "C:/backup2022_12_5/backup2022_12_5/Qt-Camera/pic/20230911163856.png")
